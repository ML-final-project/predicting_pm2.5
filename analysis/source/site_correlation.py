...
df.columns 
small_df = df.drop(columns = ['Unnamed: 0','aod47', 'aod55','station_name','elevation',
...
pm25 = small_df.pivot_table(index='date', columns='site_name', values='daily_mean_pm_2_5_concentration', aggfunc='mean')

#need to make site name into col name
#and date into row

pm25.iloc[0,2]
overall_pearson_r = pm25.corr().iloc[0,1]
print(f"Pandas computed Pearson r: {overall_pearson_r}")
#Outbut Pandas computed Pearson r: 0.8578030881698346
